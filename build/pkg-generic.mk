...
define check_host_rpath
	$(if $(filter install-host,$(2)),\
		$(if $(filter end,$(1)),build/scripts/check-host-rpath $(3) $(HOST_DIR) $(PER_PACKAGE_DIR)))
endef
...
define check_bin_arch
	build/scripts/check-bin-arch -p $($(PKG)_NAME) \
...
$(BUILD_DIR)/%/.stamp_patched:
	...
	for D in $(PATCH_BASE_DIRS); do \
	  if test -d $${D}; then \
	    if test -z "$($(PKG)_VERSION)"; then \
	      $(APPLY_PATCHES) $(PKGD) $${D} \*.patch \*.patch.$(ARCH) || exit 1; \
	    elif test -d $${D}/_$($(PKG)_VERSION); then \
...
define pkg-graph-depends
	...
	@cd "$$(CONFIG_DIR)"; \
	$$(TOPDIR)/build/scripts/graph-depends $$(BR2_GRAPH_DEPS_OPTS) \
...
$(2)_PKGDIR			=  $(pkgdir)
$(2)_PKGD                       =  $(TOPDIR)/$(pkgdir)source/$$($(2)_SUBDIR)
...
$(2)_CLEAN_CMDS ?= \
	$$(TARGET_MAKE_ENV) $$($$(PKG)_MAKE_ENV) $$(MAKE) O=$$($$(PKG)_DIR) $$($$(PKG)_MAKE_FLAGS) -C $$($$(PKG)_PKGD) clean
$(2)_BUILD_CMDS ?= \
	$$(TARGET_MAKE_ENV) $$($$(PKG)_MAKE_ENV) $$(MAKE) O=$$($$(PKG)_DIR) $$($$(PKG)_MAKE_FLAGS) -C $$($$(PKG)_PKGD) all
$(2)_INSTALL_STAGING_CMDS ?= \
	$$(TARGET_MAKE_ENV) $$($$(PKG)_MAKE_ENV) $$(MAKE) O=$$($$(PKG)_DIR) -C $$($$(PKG)_PKGD) install
else
$(2)_CLEAN_CMDS ?= \
	$$(TARGET_MAKE_ENV) $$($$(PKG)_MAKE_ENV) $$(MAKE) -C $$($$(PKG)_DIR) clean
endif

ifeq ($$($(2)_SUPPORT_SEPARATE_OUTPUT),YES)
$(2)_BSYNC_CMDS = \
	$(TOPDIR)/build/scripts/mkmakefile $$($$(PKG)_PKGD) $$($$(PKG)_DIR)
else
  ifneq ($$($(2)_SOURCE)$$($(2)_SITE),)
  $(2)_BSYNC_CMDS =
  else
  $(2)_BSYNC_CMDS = \
	rsync -au $(RSYNC_VCS_EXCLUSIONS) $$($$(PKG)_PKGD)/ $$($$(PKG)_DIR)
  endif
endif
...
$(1)-clean:		$(1)-clean-for-rebuild $$($(2)_TARGET_CLEAN)

# define the PKG variable for all targets, containing the
# uppercase package variable prefix
$$($(2)_TARGET_INSTALL):		PKG=$(2)
$$($(2)_TARGET_INSTALL):		PKGD=$$($(2)_PKGD)
$$($(2)_TARGET_INSTALL_TARGET):		PKG=$(2)
$$($(2)_TARGET_INSTALL_TARGET):		PKGD=$$($(2)_PKGD)
$$($(2)_TARGET_INSTALL_STAGING):	PKG=$(2)
$$($(2)_TARGET_INSTALL_STAGING):	PKGD=$$($(2)_PKGD)
$$($(2)_TARGET_INSTALL_IMAGES):		PKG=$(2)
$$($(2)_TARGET_INSTALL_IMAGES):		PKGD=$$($(2)_PKGD)
$$($(2)_TARGET_INSTALL_HOST):		PKG=$(2)
$$($(2)_TARGET_INSTALL_HOST):		PKGD=$$($(2)_PKGD)
$$($(2)_TARGET_BUILD):			PKG=$(2)
$$($(2)_TARGET_BUILD):			PKGD=$$($(2)_PKGD)
$$($(2)_TARGET_CONFIGURE):		PKG=$(2)
$$($(2)_TARGET_CONFIGURE):		PKGD=$$($(2)_PKGD)
$$($(2)_TARGET_CONFIGURE):		NAME=$(1)
$$($(2)_TARGET_RSYNC):			SRCDIR=$$($(2)_OVERRIDE_SRCDIR)
$$($(2)_TARGET_RSYNC):			PKG=$(2)
$$($(2)_TARGET_RSYNC):			PKGD=$$($(2)_PKGD)
$$($(2)_TARGET_PATCH):			PKG=$(2)
$$($(2)_TARGET_PATCH):			RAWNAME=$$(patsubst host-%,%,$(1))
$$($(2)_TARGET_PATCH):			PKGDIR=$(pkgdir)
$$($(2)_TARGET_PATCH):			PKGD=$$($(2)_PKGD)
$$($(2)_TARGET_EXTRACT):		PKG=$(2)
$$($(2)_TARGET_EXTRACT):		PKGD=$$($(2)_PKGD)
$$($(2)_TARGET_SOURCE):			PKG=$(2)
$$($(2)_TARGET_SOURCE):			PKGDIR=$(pkgdir)
$$($(2)_TARGET_SOURCE):			PKGD=$$($(2)_PKGD)
$$($(2)_TARGET_ACTUAL_SOURCE):		PKG=$(2)
$$($(2)_TARGET_ACTUAL_SOURCE):		PKGDIR=$(pkgdir)
$$($(2)_TARGET_ACTUAL_SOURCE):		PKGD=$$($(2)_PKGD)
$$($(2)_TARGET_DIRCLEAN):		PKG=$(2)
$$($(2)_TARGET_DIRCLEAN):		NAME=$(1)
$$($(2)_TARGET_DIRCLEAN):		PKGD=$$($(2)_PKGD)
$$($(2)_TARGET_CLEAN):			PKG=$(2)
$$($(2)_TARGET_CLEAN):			PKGD=$$($(2)_PKGD)
$$($(2)_TARGET_CLEAN):			PKGDIR=$(TOPDIR)/$(pkgdir)
