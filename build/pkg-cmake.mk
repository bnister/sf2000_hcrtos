...
$(2)_DEPENDENCIES += toolchainfilecmake
...
define TOOLCHAIN_CMAKE_INSTALL_FILES
	...
	sed \
		...
		-e 's#@@TARGET_FC@@#$(call qstrip,$(TARGET_FC))#' \
		...
		$(TOPDIR)/build/misc/toolchainfile.cmake.in \
		> $(HOST_DIR)/share/buildroot/toolchainfile.cmake
	$(Q)install -D -m 0644 build/misc/Buildroot.cmake \
		$(HOST_DIR)/share/buildroot/Platform/Buildroot.cmake
endef

TOOLCHAIN_POST_INSTALL_STAGING_HOOKS += TOOLCHAIN_CMAKE_INSTALL_FILES

toolchainfilecmake: $(HOST_DIR)/share/buildroot/toolchainfile.cmake
$(HOST_DIR)/share/buildroot/toolchainfile.cmake:
	$(foreach hook,$(TOOLCHAIN_POST_INSTALL_STAGING_HOOKS),$(call $(hook))$(sep))
