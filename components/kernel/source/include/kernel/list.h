...
/*
 * Simple doubly linked list implementation borrowed from Linux kernel.
 *
 ...
 */
#define LIST_POISON1  ((void *) 0xDEAD0100)
#define LIST_POISON2  ((void *) 0xDEAD0200)
...
#define slist_first(head) ((head)->next)
...
static inline void slist_append(slist_t *l, slist_t *n)
{
	...
	node->next = n;
	n->next = (struct slist_node *)0;
}

static inline int slist_isempty(slist_t *l)
{
	return l->next == (struct slist_node *)0;
}
...
#define slist_for_each(pos, head) \
    for (pos = (head)->next; pos != (slist_t *)0; pos = pos->next)
