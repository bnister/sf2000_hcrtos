 ...
 */
    ...
    defined(BR2_PACKAGE_PREBUILTS_NTFS) || defined(CONFIG_FS_ELMFAT)
...
/* These file systems require MTD drivers */
     ...
     defined(CONFIG_FS_YAFFS2) || defined(CONFIG_FS_ROMFS)) && \
    defined(CONFIG_MTD)
...
#endif
#ifdef CONFIG_FS_ELMFAT
extern const struct mountpt_operations elmfat_operations;
#endif
#ifdef BR2_PACKAGE_PREBUILTS_NTFS
extern const struct mountpt_operations ntfs_operations;
#endif
...
#endif
#ifdef CONFIG_FS_ELMFAT
    { "vfat", &elmfat_operations },
#endif
#ifdef BR2_PACKAGE_PREBUILTS_NTFS
    { "ntfs", &ntfs_operations },
#endif
#ifdef CONFIG_FS_ROMFS
...
extern const struct mountpt_operations yaffs2_operations;
#endif
