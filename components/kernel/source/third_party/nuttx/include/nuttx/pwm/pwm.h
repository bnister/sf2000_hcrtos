...
#define PWMIOC_SETCHARACTERISTICS _IOW(PWM_IOCBASE, 0x0001, struct pwm_info_s)
#define PWMIOC_GETCHARACTERISTICS _IOR(PWM_IOCBASE, 0x0002, struct pwm_info_s)
#define PWMIOC_START              _IO(PWM_IOCBASE, 0x0003)
#define PWMIOC_STOP               _IO(PWM_IOCBASE, 0x0004)
