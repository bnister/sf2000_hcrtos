...
struct fs_elmfatdir_s
{
  FAR void *fs_dir;                           /* Opaque pointer to UserFS DIR */
};
#endif /* CONFIG_FS_ELMFAT */
...
#endif /* BR2_PACKAGE_PREBUILTS_NTFS */
...
#ifndef CONFIG_DISABLE_MOUNTPOINT
#ifdef CONFIG_FS_YAFFS2
      struct fs_yaffs2dir_s  yaffs2;
#endif
#ifdef CONFIG_FS_FAT
      struct fs_fatdir_s     fat;
#endif
#ifdef CONFIG_FS_ELMFAT
      struct fs_elmfatdir_s  elmfat;
#endif
#ifdef BR2_PACKAGE_PREBUILTS_NTFS
      struct fs_ntfsdir_s    ntfs;
#endif
#ifdef CONFIG_FS_ROMFS
