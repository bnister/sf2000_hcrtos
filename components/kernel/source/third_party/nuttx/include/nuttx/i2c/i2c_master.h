...
#define I2CIOC_TRANSFER      _IOWR(I2C_IOCBASE, 0x0001, struct i2c_transfer_s)
...
#define I2CIOC_RESET         _IO  (I2C_IOCBASE, 0x0002)

/* Access macros ************************************************************/

#define I2CIOC_TIMEOUT		_IO(I2C_IOCBASE, 0x0003)
/****************************************************************************
 * Name: I2C_TRANSFER
 *
 * Description:
...
#define I2C_TIMEOUT(d, t) ((d)->ops->timeout(d, t))
...
struct i2c_ops_s
{
  ...
  CODE int (*timeout)(FAR struct i2c_master_s *dev, unsigned long timeout);
#ifdef CONFIG_I2C_RESET
