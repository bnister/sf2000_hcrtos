...
extern int usb_composite_attach_driver(const char *udc_name, struct usb_composite_driver *driver);
...
#define USB_GADGET_COMPOSITE_OPTIONS()					\
	static struct usb_composite_overwrite coverwrite;	
#endif /* USB_GADGET_COMPOSITE_OPTIONS */
...
#define DECLARE_USB_FUNCTION_INIT(_name, _inst_alloc, _func_alloc)	\
	...
	static int __exit _name ## mod_exit(void)			\
	{								\
		usb_function_unregister(&_name ## usb_func);		\
	}								\
	module_others(_name, _name ## mod_init, _name ## mod_exit, 1)
