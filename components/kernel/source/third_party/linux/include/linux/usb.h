...
#include <linux/err.h>		/* for -ENODEV */
#include <linux/delay.h>	/* for mdelay() */
#include <linux/interrupt.h>	/* for in_interrupt() */
#include <linux/kref.h>		/* for struct kref */
#include <linux/device.h>	/* for struct device */
//#include <linux/fs.h>		/* for struct file_operations */
#include <kernel/completion.h>	/* for struct completion */
 ...
 */
#define module_usb_driver(__usb_driver) \
	static int usb_init_##__usb_driver(void) \
	{\
		usb_register_driver(&__usb_driver, THIS_MODULE, KBUILD_MODNAME);\
		return 0;\
	}\
	static int usb_deinit_##__usb_driver(void) \
	{\
		usb_deregister(&__usb_driver);\
		return 0;\
	}\
	module_driver(__usb_driver, usb_init_##__usb_driver, \
			usb_deinit_##__usb_driver, 0)
