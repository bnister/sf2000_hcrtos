...
#include <kernel/drivers/input.h> //#include <linux/input.h>
 ...
 */
#define module_hid_driver(__hid_driver) \
	static int hid_init_##__hid_driver(void) \
	{\
		hid_register_driver(&__hid_driver);\
		return 0;\
	}\
	static int hid_deinit_##__hid_driver(void) \
	{\
		hid_unregister_driver(&__hid_driver);\
		return 0;\
	}\
	module_driver(__hid_driver, hid_init_##__hid_driver, \
			hid_deinit_##__hid_driver, 0)
