			      ...
			      uint8_t align)
{
	...
	WM8960_Write_Reg(fd, 0x07, 0x0003); //0x0082 0x0083 0x0003
	...
	msleep(1000);
	printf("wm8960i-dai wm8960i_dai_hw_params end\n");
...
static struct snd_soc_dai wm8960i_dai = {
	.name = "wm8960i-dai",
	.driver = &wm8960i_dai_driver,
	.priv = &dai_dev,
};

static struct snd_soc_dai wm8960_for_pcmi0_dai = {
	.name = "wm8960-for-pcmi0-dai",
	.driver = &wm8960i_dai_driver,
	.priv = &dai_dev,
};

static struct snd_soc_dai wm8960_for_pcmi1_dai = {
	.name = "wm8960-for-pcmi1-dai",
	.driver = &wm8960i_dai_driver,
	.priv = &dai_dev,
};

static struct snd_soc_dai wm8960_for_pcmi2_dai = {
...
int wm8960i_dai_init(void)
{
	...
	snd_soc_register_dai(&wm8960i_dai);

	snd_soc_register_dai(&wm8960_for_pcmi0_dai);

	snd_soc_register_dai(&wm8960_for_pcmi1_dai);

	snd_soc_register_dai(&wm8960_for_pcmi2_dai);
}
