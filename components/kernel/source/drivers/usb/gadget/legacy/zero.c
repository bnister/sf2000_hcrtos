...
#define DRIVER_VERSION		"Hichip 2023/02"

static const char longname[] = "Hichip Gadget Zero";
...
{
	if(!udc_name){
		pr_err("[error] please input correct parameters\n");
		return -1;
	}
	return usb_composite_attach_driver(udc_name, &zero_driver);
}
