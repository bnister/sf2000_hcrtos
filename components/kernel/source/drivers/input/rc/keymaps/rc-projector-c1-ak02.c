...
static struct rc_map_table rc_projector_c1_ak02[] = {
	...
	{ 0x815, KEY_EXIT },
	{ 0x848, KEY_VOLUMEUP },
	{ 0x849, KEY_VOLUMEDOWN },
	{ 0x80f, KEY_BACK },
	{ 0x874, KEY_CAMERA_FOCUS},
	{ 0x855, KEY_FORWARD },
	{ 0x814, KEY_MUTE },
	#endif
	#if 0
...
module_driver(rc_map_rc_projector_c1_ak02, init_rc_map_rc_projector_c1_ak02, NULL, 0)
