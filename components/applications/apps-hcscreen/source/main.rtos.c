...
int hcscreenapp_main(int argc, char **argv)
{
    pthread_t pid;
    pthread_attr_t attr;
...
{
    network_manual_connect(argc, argv);
    return 0;
}

static int hcscreenapp_start(void)
{
	hcscreenapp_main(0, NULL);
	return 0;
}

__initcall(hcscreenapp_start)
...
static void app_main(void *pvParameters)
{
    ...
    //console_register_cmd(NULL, "hcscreenapp", hcscreenapp_main, CONSOLE_CMD_MODE_SELF, "hcscreenapp");
