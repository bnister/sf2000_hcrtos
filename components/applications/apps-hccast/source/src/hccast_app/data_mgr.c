...
static void data_mgr_default_init(void)
{
    ...
    m_app_data.wifi_mode = api_get_wifi_freq_mode(); // 1: 2.4, 2: 5G, 3: 60G
    if (1 == m_app_data.wifi_mode)
    {
        m_app_data.wifi_ch   = HOATAP_CHANNEL_24G;
    }
    else if  (2 == m_app_data.wifi_mode)
    {
        m_app_data.wifi_ch   = HOATAP_CHANNEL_5G;
    }
    /*
    else if  (3 == m_app_data.wifi_mode)
    {
        m_app_data.wifi_ch   = 3;
    }
    */
    else
    {
