...
typedef struct MDCT15Context {
    ...
    void (*mdct)(struct MDCT15Context *s, FFTSample *dst, const FFTSample *src, ptrdiff_t stride);

    /* Calculate the middle half of the iMDCT */
    void (*imdct_half)(struct MDCT15Context *s, FFTSample *dst, const FFTSample *src,
                       ptrdiff_t stride);
} MDCT15Context;

#define ff_mdct15_init FFT_NAME(ff_mdct15_init)
#define ff_mdct15_uninit FFT_NAME(ff_mdct15_uninit)
