...
int avcodec_decode_bmp_frame(AVCodecContext *avctx,
                            ...
                            AVPacket *avpkt)
{
    ...
    case 32:
        if (comp == BMP_BITFIELDS) {
            ...
            /* Note for 16-bit and 32-bit Windows BMP files, the BMP codec ignores any alpha channel,
             * as many legacy image files contain invalid data in this extra channel.
             * Starting with Windows 8, 32-bit Windows BMP files written using the BITMAPV5HEADER
             * with valid alpha channel content are read as WICPixelFormat32bppBGRA
             */
            av_log(avctx, AV_LOG_VERBOSE,"ignore alpha value");
...
AVCodec ff_bmp_decoder = {
    ...
    .id             = AV_CODEC_ID_BMP,
    .decode         = avcodec_decode_bmp_frame,
