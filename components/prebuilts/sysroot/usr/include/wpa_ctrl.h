 ...
 */
struct wpa_ctrl * wpa_ctrl_open(const char *ctrl_path, int port);
...
#define WPA_CTRL_WPA_IFACE_PORT WPA_CTRL_IFACE_PORT
#define WPA_CTRL_P2P_IFACE_PORT 9890
#define WPA_CTRL_HOSTAPD_IFACE_PORT 9892
