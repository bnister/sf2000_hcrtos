 ...
 ****************************************************************************/
#ifdef CONFIG_NSH_CMD_MODE_ALL
#define NSH_CONSOLE_CMD(_cmd, _parent, _callback, _mode, _help)                \
	CONSOLE_CMD(_cmd, NULL, _callback, CONSOLE_CMD_MODE_ALL, _help)
#else
#define NSH_CONSOLE_CMD(_cmd, _parent, _callback, _mode, _help)                \
	CONSOLE_CMD(_cmd, _parent, _callback, _mode, _help)
#endif
